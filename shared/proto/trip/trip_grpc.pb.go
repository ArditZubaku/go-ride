...
type TripServiceClient interface {
	PreviewTrip(ctx context.Context, in *PreviewTripReq, opts ...grpc.CallOption) (*PreviewTripRes, error)
	CreateTrip(ctx context.Context, in *CreateTripReq, opts ...grpc.CallOption) (*CreateTripRes, error)
}
...
func (c *tripServiceClient) PreviewTrip(ctx context.Context, in *PreviewTripReq, opts ...grpc.CallOption) (*PreviewTripRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PreviewTripRes)
...
func (c *tripServiceClient) CreateTrip(ctx context.Context, in *CreateTripReq, opts ...grpc.CallOption) (*CreateTripRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateTripRes)
...
type TripServiceServer interface {
	PreviewTrip(context.Context, *PreviewTripReq) (*PreviewTripRes, error)
	CreateTrip(context.Context, *CreateTripReq) (*CreateTripRes, error)
...
func (UnimplementedTripServiceServer) PreviewTrip(context.Context, *PreviewTripReq) (*PreviewTripRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreviewTrip not implemented")
}
func (UnimplementedTripServiceServer) CreateTrip(context.Context, *CreateTripReq) (*CreateTripRes, error) {
...
func _TripService_PreviewTrip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).PreviewTrip(ctx, req.(*PreviewTripReq))
	}
